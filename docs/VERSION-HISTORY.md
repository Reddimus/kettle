...
- Current workspace version: `2.43.0`
- Release records inspected: 147 Git tags and 147 changelog headings, from
  `v0.1.0` through `v2.43.0`
...
- `v2.21.0` to `v2.28.0` (2026-06-13 to 2026-06-19): GPU/background features,
  ...
  refreshes.
- `v2.29.0` to `v2.43.0` (2026-06-19 to 2026-07-28): cwd-aware titles and
