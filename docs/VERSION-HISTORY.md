...
- Current workspace version: `2.37.0`
- Release records inspected: 139 Git tags and 139 changelog headings, from
  `v0.1.0` through `v2.37.0`
...
- `v2.21.0` to `v2.28.0` (2026-06-13 to 2026-06-19): GPU/background features,
  ...
  refreshes.
- `v2.29.0` to `v2.37.0` (2026-06-19 to 2026-07-22): cwd-aware titles and
