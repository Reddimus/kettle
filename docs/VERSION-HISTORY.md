...
- Latest version in this tree: `v4.0.1` — carried by the changelog and the
  ...
  shipped.
- Current workspace version: `4.0.1`
- Release records inspected: 168 Git tags and 169 changelog headings, from
  `v0.1.0` through `v4.0.0`. The counts are equal after a release tag is
