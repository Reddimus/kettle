...
- Latest version in this tree: `v3.0.0` — carried by the changelog and the
  ...
  shipped.
- Current workspace version: `3.0.0`
- Release records inspected: 160 Git tags and 161 changelog headings, from
  `v0.1.0` through `v2.56.0`. The counts differ by one on purpose: the
...
- `v2.21.0` to `v2.28.0` (2026-06-13 to 2026-06-19): GPU/background features,
  ...
  refreshes.
- `v2.29.0` to `v3.0.0` (2026-06-19 to 2026-08-12): cwd-aware titles and
