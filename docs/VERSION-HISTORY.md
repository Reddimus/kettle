...
- Latest version in this tree: `v4.1.0` — carried by the changelog and the
  ...
  shipped.
- Current workspace version: `4.1.0`
- Release records inspected: 169 Git tags and 170 changelog headings, from
  `v0.1.0` through `v4.0.1`. The counts are equal after a release tag is
