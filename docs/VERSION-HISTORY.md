...
- Latest version in this tree: `v4.0.0` — carried by the changelog and the
  ...
  shipped.
- Current workspace version: `4.0.0`
- Release records inspected: 167 Git tags and 168 changelog headings, from
