...
- Current workspace version: `2.36.3`
- Release records inspected: 135 Git tags and 135 changelog headings, from
  `v0.1.0` through `v2.36.3`
...
- `v2.21.0` to `v2.28.0` (2026-06-13 to 2026-06-19): GPU/background features,
  ...
  refreshes.
- `v2.29.0` to `v2.36.3` (2026-06-19 to 2026-07-16): cwd-aware titles and
