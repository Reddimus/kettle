...
- Latest version in this tree: `v4.5.2`, with matching source version,
  changelog heading, and Git tag.
- Current workspace version: `4.5.2`
- Release headings inspected: 178 across the root `CHANGELOG.md` and
  `docs/changelog/` archives. That count comprises `[Unreleased]` and 177 dated
  versions from `v0.1.0` through `v4.5.2`.
