...
- Latest version in this tree: `v4.4.0`, with matching source version,
  changelog heading, and Git tag.
- Current workspace version: `4.4.0`
- Release headings inspected: 175 across the root `CHANGELOG.md` and
  `docs/changelog/` archives. That count comprises `[Unreleased]` and 174 dated
  versions from `v0.1.0` through `v4.4.0`.
