...
- Latest version in this tree: `v2.55.0` — carried by the changelog and the
  ...
  shipped.
- Current workspace version: `2.55.0`
- Release records inspected: 158 Git tags and 159 changelog headings, from
  `v0.1.0` through `v2.54.0`. The counts differ by one on purpose: the
...
- `v2.21.0` to `v2.28.0` (2026-06-13 to 2026-06-19): GPU/background features,
  ...
  refreshes.
- `v2.29.0` to `v2.55.0` (2026-06-19 to 2026-08-09): cwd-aware titles and
