...
## v1.32.0 → v1.41.0 — post-sweep production polish (cycles 411-521, shipped)

One hundred eleven cycles + ten releases hardening the plugin
contract, ergonomics, doc-accuracy, doc-durability, build-time
infrastructure (opt-in pre-commit hook + shellcheck gate), and
crates.io metadata polish around the v1.8.0 → v1.31.0 sweep. See
