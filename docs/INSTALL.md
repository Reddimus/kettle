...
```sh
# Linux / WSL
curl -fLO https://github.com/Reddimus/kettle/releases/download/v2.15.1/kettle-linux-x86_64.tar.gz
curl -fLO https://github.com/Reddimus/kettle/releases/download/v2.15.1/kettle-linux-x86_64.tar.gz.sha256
