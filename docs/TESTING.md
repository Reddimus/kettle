...
- **kettle-core VT conformance** (14 tests): drives the *real* vte +
  ...
  ops, DECID reply, cursor-blink mode (?12) event, CHT/CBT tab
  navigation. The automatable, regression-proof core of a `vttest`
  sweep.
