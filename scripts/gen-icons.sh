...
# the Windows dev host). The committed rasters come from the .py. The two
# rasterizers are visually equivalent but NOT byte-identical
# (anti-aliasing + PNG compression differ; both are valid 8-bit RGBA) —
# whichever you use, commit one consistently.
#
